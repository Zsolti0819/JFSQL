...
/**
 * This interface defines a complete generic visitor for a parse tree produced by {@link JFSQLParser}.
 *
...
public interface JFSQLVisitor<T> extends ParseTreeVisitor<T> {
    ...
    /**
     * Visit a parse tree produced by {@link JFSQLParser#createDatabase}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitCreateDatabase(JFSQLParser.CreateDatabaseContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link JFSQLParser#dropDatabase}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitDropDatabase(JFSQLParser.DropDatabaseContext ctx);
    ...
    /**
     * Visit a parse tree produced by {@link JFSQLParser#databaseUrl}.
     *
     * @param ctx the parse tree
     * @return the visitor result
     */
    T visitDatabaseUrl(JFSQLParser.DatabaseUrlContext ctx);
