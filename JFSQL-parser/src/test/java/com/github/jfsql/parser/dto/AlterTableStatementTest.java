...
class AlterTableStatementTest {
    ...
    void testAlterTableStatements(final String statement, final String tableName, final String newTableName, final String oldColumnName, final String newColumnName, final String columnNameToAdd, final String columnTypeToAdd, final String columnToDrop) {
